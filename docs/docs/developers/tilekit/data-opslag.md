...
!!! example "Voorbeeld: De Windmolen"
    Stel je voor dat de camera op een vast punt in de wereld gericht is en ik een windmolen als object heb. Dan is deze 
    windmolen zichtbaar (in beeld) als zijn positie op de X-, Y- of Z-as zo is dat die valt binnen camerabeeld valt. Dat is 
    zichtbaarheid in 3 dimensies.
