...
<div style="display: flex; align-items: flex-start; gap: 15px;" markdown>
   ...
   ![Zoekmenu](../handleiding/imgs/lagen.menu.main.png){ width="240px" align=left }
...
/// caption
(Afbeelding) Rangschikken van lagen
///
...
/// caption
(Afbeelding) Transformatie tool geactiveerd door selectie in Lagen
///
...
/// caption
(Afbeelding) Instellingen actief
///
...
/// caption
Afgeschermde bronnen paneel aanroepen
///
...
/// caption
Afgeschermde bronnen paneel wissel
///
...
/// caption
Afgeschermde bronnen paneel code/gebruikersnaam-wachtwoord
///
